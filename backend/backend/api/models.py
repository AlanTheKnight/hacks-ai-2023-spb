...
class Result(models.Model):
    ...
    name_status = models.CharField("Статус названия", max_length=100, default="В очереди")
    logo_status = models.CharField("Статус логотипа", max_length=100, default="В очереди")
    pptx_status = models.CharField("Статус PPTX", max_length=100, default="В очереди")
